 ...
 * BVC
 *
 * Generates code for handling the BVC instruction. There are 256 opcode words from $6x00-$6xFF,
 ...
 * albeit not legal.
 *
 * BVC takes the branch when the V flag is clear
 */
...
return function(int $iOpcode): void {
    if (
        0 === ($this->iConditionRegister & IRegister::CCR_OVERFLOW)
    ) {
<?php
