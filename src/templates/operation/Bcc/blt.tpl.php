 ...
 * BLT
 *
 * Generates code for handling the BLT instruction. There are 256 opcode words from $6x00-$6xFF,
 ...
 * albeit not legal.
 *
 * BLT takes the branch when the N flag is clear and the V flag is set OR the N flag is set and
 * the V flag is clear
 */
