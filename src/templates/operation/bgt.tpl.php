 ...
 * BGT
 *
 * Generates code for handling the BGT instruction. There are 256 opcode words from $6x00-$6xFF,
 ...
 * albeit not legal.
 *
 * BGE takes the branch when the Z, N and V flags are all clear OR the Z flag is clear but the
 * N and V flags are both set.
 */
