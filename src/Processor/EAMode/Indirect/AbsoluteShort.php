...
/**
 * 16-bit absolute location
 */
class AbsoluteShort implements EAMode\IIndirect
{
    ...
    {
        $iAddress = Processor\Sign::extWord($this->oOutside->readWord($this->iProgramCounter));
        $this->iProgramCounter += ISize::WORD;
        return $this->iAddress = $iAddress & ISize::MASK_LONG;
    }
